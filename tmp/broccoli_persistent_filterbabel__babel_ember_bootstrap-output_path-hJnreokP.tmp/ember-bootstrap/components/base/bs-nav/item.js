define('ember-bootstrap/components/base/bs-nav/item', ['exports', 'ember-bootstrap/templates/components/bs-nav/item', 'ember-bootstrap/mixins/component-parent', 'ember-bootstrap/utils/overrideable-cp'], function (exports, _item, _componentParent, _overrideableCp) {
  'use strict';
  ...
  exports.default = Ember.Component.extend(_componentParent.default, {
     ...
     * @public
     */
    disabled: (0, _overrideableCp.default)('_disabled', function () {
     ...
     * @public
     */
    active: (0, _overrideableCp.default)('_active', function () {
