define('ember-bootstrap/components/base/bs-carousel/slide', ['exports', 'ember-bootstrap/mixins/component-child', 'ember-bootstrap/templates/components/bs-carousel/slide', 'ember-bootstrap/utils/overrideable-cp'], function (exports, _componentChild, _slide, _overrideableCp) {
  'use strict';
  ...
  exports.default = Ember.Component.extend(_componentChild.default, {
     ...
     * @private
     */
    active: (0, _overrideableCp.default)('isCurrentSlide', 'presentationState', function () {
