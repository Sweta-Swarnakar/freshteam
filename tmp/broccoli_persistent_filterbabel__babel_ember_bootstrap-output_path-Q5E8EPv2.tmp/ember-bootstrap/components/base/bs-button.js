define('ember-bootstrap/components/base/bs-button', ['exports', 'ember-bootstrap/templates/components/bs-button', 'ember-bootstrap/mixins/type-class', 'ember-bootstrap/mixins/size-class', 'ember-bootstrap/utils/overrideable-cp'], function (exports, _bsButton, _typeClass, _sizeClass, _overrideableCp) {
  'use strict';
  ...
  exports.default = Ember.Component.extend(_typeClass.default, _sizeClass.default, {
     ...
     * @public
     */
    icon: (0, _overrideableCp.default)('active', function () {
      if (this.get('active')) {
