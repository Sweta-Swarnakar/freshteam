...
;define("fresh-team/templates/users", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "JDDuiG9I", "block": "{\"symbols\":[],\"statements\":[[1,[21,\"outlet\"],false]],\"hasEval\":false}", "meta": { "moduleName": "fresh-team/templates/users.hbs" } });
});
;
...
;
          if (!runningTests) {
            require("fresh-team/app")["default"].create({"name":"fresh-team","version":"0.0.0+2a7f227d"});
          }
